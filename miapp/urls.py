...
from miapp.views import (
    ...
    lista_compras, detalle_compra, index, ver_carrito, CustomLoginView, CustomLogoutView, registro
)
...
urlpatterns = [
    ...
    path('registro/', registro, name='registro'),  # Ruta agregada para el registro
]
